...
if __name__ == '__main__':
	...
	log = f'**Initial: {old_infected_attributes[NodeType.USB]}/{total_attributes[NodeType.USB]} USB nodes infected**\n'
	for wave in range(INFECTION_DURATION // WAVE_DURATION):
		...
		log = add_line_to_log(log, f'- **Overall healthy:** +{new_infected_attributes["total"] - old_infected_attributes["total"]}, {new_infected_attributes["total"]}/{total_attributes["total"]} total')
